...
###############################################################
    ...
    def __init__(self):
        ...
        locations['起始点'] = Pose(Point(1.272, -0.814, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['厨房'] = Pose(Point(3.233, 1.638, 0.000), Quaternion(00.000, 0.000, 0.000, 1.000))
        locations['卧室'] = Pose(Point(2.173, 1.143, 0.000), Quaternion(0.000, 0.000, 0.922, 0.388))
        locations['客厅'] = Pose(Point(3.671, 0.054, 0.000), Quaternion(0.000, 0.000, -0.321, 0.947))      
