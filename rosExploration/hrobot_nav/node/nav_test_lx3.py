...
###############################################################
    ...
    def __init__(self):
        ...
        locations['B'] = Pose(Point(2.539, 1.657, 0.000), Quaternion(00.000, 0.000, 0.000, 1.000))
        locations['C'] = Pose(Point(1.337, 1.090, 0.000), Quaternion(0.000, 0.000, 0.924, 0.382))
