...
std::cout<<"local map test by ding"<<std::endl;   //by ding
...
std::cout<<"local point test by ding"<<std::endl;   //by ding
...
// generate the same numbers as in the original C test program
  ...
  std::cout<<"my local test  : "<<std::endl;    //by ding
  ...
  std::cout<<"local ns : "+ns<<std::endl;    //by ding

  ros::param::param<float>("/eta", eta, 0.5);     //by ding
  ros::param::param<std::string>("/map_topic", map_topic, "/map");   //by ding 

  std::cout<<"local map_topic : "+map_topic<<std::endl;    //by ding

  ros::param::param<std::string>("/robot_frame", base_frame_topic, "/base_footprint");   //by ding 
//---------------------------------------------------------------
